...
public class WinCheckModul {
    ...
    private boolean winCheck(final GameTable gameTable, final Symbol symbol) {
    ...
    private boolean winCheckByRows(GameTable gameTable, final Symbol symbol) {
        for (int i = 0; i < 3; i++) {
    ...
    private boolean winCheckByCols(GameTable gameTable, final Symbol symbol) {
        for (int i = 0; i < 3; i++) {
    ...
    private boolean winCheckByDiagonalOne(GameTable gameTable, final Symbol symbol) {
    ...
    private boolean winCheckByDiagonalTwo(GameTable gameTable, final Symbol symbol) {
